...
/** Configuration for venue management with Map-based O(1) lookup. Loads from venues.yml file. */
@Data
@Configuration
@Validated
...
public class VenueConfig {
  ...
  @Valid private DefaultSettings defaultConfig;

  /** Single venue configuration matching Venue model structure. */
  @Data
  @Validated
  public static class Venue {
    @Valid private ZoneSettings zones;
  }
