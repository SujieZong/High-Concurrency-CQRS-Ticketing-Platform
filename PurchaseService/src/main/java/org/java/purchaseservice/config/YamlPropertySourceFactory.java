...
/**
 * Custom PropertySource factory for loading YAML files with @PropertySource
 * annotation.
 */
public class YamlPropertySourceFactory implements PropertySourceFactory {
    ...
    public PropertySource<?> createPropertySource(@Nullable String name, @NonNull EncodedResource resource)
        ...
        if (sources.isEmpty()) {
            throw new IllegalArgumentException("No property sources found in " + resource.getResource().getFilename());
        }
